...
from cryptopals.s2 import ecb_encrypt, oracle_builder, guess_blocksize, guess_unknown_string_size, break_ecb
...
def test_challenge12():
    ...
    oracle = oracle_builder(key, unknown)
...
def test_guess_blocksize(unknown_text, key):
    ...
    """
    oracle = oracle_builder(key, unknown_text)
